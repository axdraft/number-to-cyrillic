...
function numberToString(number, options) {
  ...
  if (options) {
    ...
    if (typeof options.language === 'string') {
      defaultOptions.language = options.language;
    }
  }
  ...
  var textValues = {
    ...
    en: {
      ...
      currency: {
        ...
        eur: {
          ...
          decimalNameCases: ['euro cent', 'euro cents', 'euro cents'],
          currencyValueCase: 1,
          decimalValueCase: 0,
          shortName: 'EUR'
        },
        noCurrency: {
          ...
          // decimalNameCases: ['decimal', 'decimal', 'decimal'],
          // currencyValueCase: 0,
          // decimalValueCase: 0
        }
      }
    ...
    ru: {
      ...
      currency: {
        ...
        usd: {
          currencyNameCases: ['доллар США', 'доллары США', 'долларов США'],
